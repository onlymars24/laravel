...
@section('content')
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="{{route('create-act')}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}   
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" id="simpleinput" class="form-control" style="{{ $errors->first('name') ? 'border: 1px red solid;' : '' }}">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" name="email" class="form-control" style="{{ $errors->first('email') ? 'border: 1px red solid;' : '' }}">
                                    @if(!empty($errors->first('email')))
                                        <label style="color: red; display: block;" for="simpleinput">{{ $errors->first('email') }}</label>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="simpleinput" class="form-control" style="{{ $errors->first('password') ? 'border: 1px red solid;' : '' }}">
                                    @if(!empty($errors->first('password')))
                                        <label style="color: red; display: block;" for="simpleinput">{{ $errors->first('password') }}</label>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="img" type="file" id="example-fileinput" class="form-control-file" style="{{ $errors->first('img') ? 'border: 1px red solid;' : '' }}">
                                    @if(!empty($errors->first('img')))
                                        <label style="color: red; display: block;" for="simpleinput">{{ $errors->first('img') }}</label>
                                    @endif
                                </div>
                                </div>
                            </div>
